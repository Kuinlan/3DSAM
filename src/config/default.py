...
_CN.THREEDSAM.D_MODEL = 256
_CN.THREEDSAM.NUM_ANCHOR = 32
_CN.THREEDSAM.NUM_BANDS = 16
...
# 5. structure extractor config
_CN.THREEDSAM.STRUCTURE_EXTRACTOR = CN()
...
_CN.THREEDSAM.DEPTH_COARSE.EPIPOLAR = True
...
_CN.THREEDSAM.LOSS.NUM_BIN = 64
_CN.THREEDSAM.LOSS.DEPTH_FOCAL_WEIGHT = 1.0
_CN.THREEDSAM.LOSS.DEPTH_DENSE_WEIGHT = 1.0
