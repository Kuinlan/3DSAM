...
##############  ↓  ThreeDSAM   ↓  ##############
_CN.THREEDSAM = CN()
_CN.THREEDSAM.N_ITER = 2
_CN.THREEDSAM.LAYER_ASSIGN = [0, 1]
...
_CN.THREEDSAM.COARSE_INIT.MP = False
_CN.THREEDSAM.COARSE_INIT.HALF = False
_CN.THREEDSAM.COARSE_INIT.D_MODEL = 256
_CN.THREEDSAM.COARSE_INIT.D_FFN = 256
_CN.THREEDSAM.COARSE_INIT.NHEAD = 8
_CN.THREEDSAM.COARSE_INIT.LAYER_NAMES = ['self', 'cross'] * 2
_CN.THREEDSAM.COARSE_INIT.AGG_SIZE0 = 1
_CN.THREEDSAM.COARSE_INIT.AGG_SIZE1 = 1
_CN.THREEDSAM.COARSE_INIT.NO_FLASH = True
_CN.THREEDSAM.COARSE_INIT.ROPE = True  
_CN.THREEDSAM.COARSE_INIT.NPE = [480, 640, 480, 640]
_CN.THREEDSAM.COARSE_INIT.LINEAR_ATTENTION = True
...
_CN.THREEDSAM.EXTRACTOR.ANCHOR_THR = 0.3
_CN.THREEDSAM.EXTRACTOR.BORDER_RM = 2
_CN.THREEDSAM.EXTRACTOR.D_COLOR = 256
_CN.THREEDSAM.EXTRACTOR.D_STRUCT = 128 # D_STRUCT = ANCHOR_NUM * 4
...
_CN.THREEDSAM.SELF_ATTENTION.AGG_SIZE0 = 1
_CN.THREEDSAM.SELF_ATTENTION.AGG_SIZE1 = 1
...
_CN.THREEDSAM.SELF_ATTENTION.LINEAR_ATTENTION = True

# 3.3 fetch-struct-info cross attention module config
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION = CN()
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION.MP = False
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION.HALF = False
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION.D_MODEL = 256
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION.NHEAD = 8
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION.LAYER_NAMES = ['cross'] * 1
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION.AGG_SIZE0 = 1
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION.AGG_SIZE1 = 1
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION.NO_FLASH = False
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION.ROPE = True  
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION.NPE = [480, 640, 480, 640]
_CN.THREEDSAM.FETCH_STRUCT_CROSS_ATTENTION.LINEAR_ATTENTION = True

# 3.4 geometric-attention module config
_CN.THREEDSAM.GEOMETRIC_ATTENTION = CN()
_CN.THREEDSAM.GEOMETRIC_ATTENTION.D_MODEL = 256 
_CN.THREEDSAM.GEOMETRIC_ATTENTION.NHEAD = 8 
_CN.THREEDSAM.GEOMETRIC_ATTENTION.AREA_WIDTH = 4
_CN.THREEDSAM.GEOMETRIC_ATTENTION.MP = False
_CN.THREEDSAM.GEOMETRIC_ATTENTION.HALF = False
_CN.THREEDSAM.GEOMETRIC_ATTENTION.D_FFN = 256
_CN.THREEDSAM.GEOMETRIC_ATTENTION.AGG_SIZE0 = 1
_CN.THREEDSAM.GEOMETRIC_ATTENTION.AGG_SIZE1 = 1
_CN.THREEDSAM.GEOMETRIC_ATTENTION.NO_FLASH = False
_CN.THREEDSAM.GEOMETRIC_ATTENTION.ROPE = False  
_CN.THREEDSAM.GEOMETRIC_ATTENTION.NPE = [480, 640, 480, 640]
_CN.THREEDSAM.GEOMETRIC_ATTENTION.LINEAR_ATTENTION = True
...
_CN.THREEDSAM.FINE.LINEAR_ATTENTION = False
