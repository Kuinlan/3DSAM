...
_CN.THREEDSAM.DEPTH_COARSE.NUM_DEPTH_LAYERS = 4
_CN.THREEDSAM.DEPTH_COARSE.NUM_VISUAL_LAYERS = 4

# 8. Perceiver config
_CN.THREEDSAM.PERCEIVER = CN()
_CN.THREEDSAM.PERCEIVER.EMBEDDING = CN()
_CN.THREEDSAM.PERCEIVER.EMBEDDING.LATENT_NUM = 1024
_CN.THREEDSAM.PERCEIVER.EMBEDDING.LATENT_DIM = 2048
_CN.THREEDSAM.PERCEIVER.EMBEDDING.FREEZE = False

# encoder config
_CN.THREEDSAM.PERCEIVER.ENCODER = CN()
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER = CN()
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.IS_CROSS_ATTENTION = True
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.NUM_BLOCKS = 1
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.CROSS_ATTENTION_SHAPE = 'q'  # query: latents
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.USE_QUERY_RESIDUAL = True
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.QK_CHANNELS = None
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.V_CHANNELS = None
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.NUM_HEADS = 1
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.D_LATENTS = 2048
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.D_MODEL = 388  # 256+(4*16*2+4=132)=388  
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.WIDENING_FACTOR = 1
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.ATTENTION_DROPOUT = 0.1
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.HIDDEN_ACTIV = 'gelu'
_CN.THREEDSAM.PERCEIVER.ENCODER.CROSS_LAYER.USE_FLASH_ATTENTION = False 

_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER = CN()
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.NUM_SELF_ATTENDS_PER_BLOCK = 4
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.IS_CROSS_ATTENTION = False
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.CROSS_ATTENTION_SHAPE = 'q'
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.USE_QUERY_RESIDUAL = True
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.QK_CHANNELS = None
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.V_CHANNELS = None
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.NUM_HEADS = 8
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.D_LATENTS = 2048
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.WIDENING_FACTOR = 1
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.ATTENTION_DROPOUT = 0.1
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.HIDDEN_ACTIV = 'gelu'
_CN.THREEDSAM.PERCEIVER.ENCODER.SELF_LAYER.USE_FLASH_ATTENTION = False 

# decoder config
_CN.THREEDSAM.PERCEIVER.DECODER = CN()
_CN.THREEDSAM.PERCEIVER.DECODER.IS_VARIATIONAL = True
_CN.THREEDSAM.PERCEIVER.DECODER.N_VAL_SAMPLES = 8
_CN.THREEDSAM.PERCEIVER.DECODER.KLD_WEIGHT = 0.1
_CN.THREEDSAM.PERCEIVER.DECODER.OUTPUT_NUM_CHANNELS = 1  
_CN.THREEDSAM.PERCEIVER.DECODER.MAX_QUERIES = 10000 
_CN.THREEDSAM.PERCEIVER.DECODER.CROSS_ATTENTION_SHAPE = 'kv' 
_CN.THREEDSAM.PERCEIVER.DECODER.USE_QUERY_RESIDUAL = False
_CN.THREEDSAM.PERCEIVER.DECODER.QK_CHANNELS = None
_CN.THREEDSAM.PERCEIVER.DECODER.V_CHANNELS = None
_CN.THREEDSAM.PERCEIVER.DECODER.NUM_HEADS = 1
_CN.THREEDSAM.PERCEIVER.DECODER.NUM_CHANNELS = 132
_CN.THREEDSAM.PERCEIVER.DECODER.D_LATENTS = 1024
_CN.THREEDSAM.PERCEIVER.DECODER.WIDENING_FACTOR = 1
_CN.THREEDSAM.PERCEIVER.DECODER.HIDDEN_ACTIV = 'gelu'
_CN.THREEDSAM.PERCEIVER.DECODER.ATTENTION_DROPOUT = 0.1
_CN.THREEDSAM.PERCEIVER.DECODER.USE_FLASH_ATTENTION = False 
_CN.THREEDSAM.PERCEIVER.DECODER.MLP_TYPE = 'double' 
