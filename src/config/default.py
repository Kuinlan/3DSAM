...
_CN.THREEDSAM.COARSE_INIT.AGG_SIZE0 = 4
_CN.THREEDSAM.COARSE_INIT.AGG_SIZE1 = 4
_CN.THREEDSAM.COARSE_INIT.NO_FLASH = False
...
# 3.3 geometric-attention module config
...
_CN.THREEDSAM.GEOMETRIC_ATTENTION.AGG_SIZE0 = 4
_CN.THREEDSAM.GEOMETRIC_ATTENTION.AGG_SIZE1 = 4
