...
##############  ↓  ThreeDSAM   ↓  ##############
_CN.THREEDSAM = CN()
_CN.THREEDSAM.N_ITER = 3
_CN.THREEDSAM.LAYER_ASSIGN = [0, 1, 2]
...
_CN.THREEDSAM.GEOMETRIC_ATTENTION.AREA_WIDTH = 10
...
_CN.THREEDSAM.GEOMETRIC_ATTENTION.AGG_SIZE0 = 2
_CN.THREEDSAM.GEOMETRIC_ATTENTION.AGG_SIZE1 = 2
