...
_CN.THREEDSAM.CONF_MATRIX_UPDATE_WEIGHT = 1
_CN.THREEDSAM.RESOLUTION = (32, 16, 8, 2)  # options: [(8, 2), (16, 4)].THREEDSAM.BACKBONE_TYPE = 'ResNetFPN'
...
_CN.THREEDSAM.RESNETFPN.INITAL_DIM = 64
_CN.THREEDSAM.RESNETFPN.BLOCK_DIMS = [64, 128, 256, 512, 1024]
...
_CN.THREEDSAM.COARSE.ATTENTION = 'linear'  # options: ['linear', 'full']
_CN.THREEDSAM.COARSE.TEMP_BUG_FIX = True

# 3.1. 3DSAM-feature extractor config
_CN.THREEDSAM.EXTRACTOR = CN()
_CN.THREEDSAM.EXTRACTOR.ANCHOR_NUM = 32  # for training
_CN.THREEDSAM.EXTRACTOR.ANCHOR_NUM_MIN = 32  # for test/val
...
_CN.THREEDSAM.EXTRACTOR.DROPOUT_PROB = 0.8

# 3.2. Epipolar-Attention module config
_CN.THREEDSAM.EPIPOLAR_ATTENTION = CN()
_CN.THREEDSAM.EPIPOLAR_ATTENTION.AREA_WIDTH = 5
_CN.THREEDSAM.EPIPOLAR_ATTENTION.D_MODEL = 512
_CN.THREEDSAM.EPIPOLAR_ATTENTION.D_FFN = 256
_CN.THREEDSAM.EPIPOLAR_ATTENTION.NHEAD = 8
_CN.THREEDSAM.EPIPOLAR_ATTENTION.ATTENTION = 'linear'

# 3.3 self-attention module config
_CN.THREEDSAM.SELF_ATTENTION = CN()
_CN.THREEDSAM.SELF_ATTENTION.D_MODEL = 1024
_CN.THREEDSAM.SELF_ATTENTION.N_HEAD = 16
_CN.THREEDSAM.SELF_ATTENTION.ATTENTION = 'linear'
_CN.THREEDSAM.SELF_ATTENTION.LAYER_NAMES = ['self']
