...
##############  ↓  DPT   ↓  ##############
_CN.DPT = CN()
_CN.DPT.WEIGHT_PATH = '/public/home/szlsygb/Hu/3DSAM/weights/dpt/dpt_hybrid_nyu-2ce69ec7.pt'
_CN.DPT.OPTIMIZE = True

##############  ↓  ThreeDSAM   ↓  ##############
_CN.THREEDSAM = CN()
_CN.THREEDSAM.N_ITER = 4
_CN.THREEDSAM.CONF_MATRIX_UPDATE_WEIGHT = 0.5
_CN.THREEDSAM.BACKBONE_TYPE = 'ResNetFPN'
_CN.THREEDSAM.RESOLUTION = (32, 16, 8, 2)  # options: [(8, 2), (16, 4)]
...
_CN.THREEDSAM.RESNETFPN.BLOCK_DIMS = [64, 128, 256, 512, 768]
...
_CN.THREEDSAM.EPIPOLAR_ATTENTION.AREA_WIDTH = 3
_CN.THREEDSAM.EPIPOLAR_ATTENTION.D_MODEL = 768
_CN.THREEDSAM.EPIPOLAR_ATTENTION.D_FFN = 256
_CN.THREEDSAM.EPIPOLAR_ATTENTION.NHEAD = 16
_CN.THREEDSAM.EPIPOLAR_ATTENTION.ATTENTION = 'linear'

# 3.3 self-attention module config
_CN.THREEDSAM.SELF_ATTENTION = CN()
_CN.THREEDSAM.SELF_ATTENTION.D_MODEL = 512
