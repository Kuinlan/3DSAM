...
_CN.THREEDSAM.LAYER_ASSIGN = [0, 1, 1, 1]
...
_CN.THREEDSAM.COARSE.NPE = [640, 640, 640, 640]
...
_CN.THREEDSAM.EPIPOLAR_ATTENTION.LAYER_NAMES = ['cross']
...
_CN.THREEDSAM.EPIPOLAR_ATTENTION.ROPE = True  
...
_CN.THREEDSAM.SELF_ATTENTION.ROPE = True  
