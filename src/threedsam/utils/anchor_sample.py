...
def get_anchor(b_ids, i_ids, j_ids, mconf, batch_size, 
                anchor_num_max, is_training, data):

    scale = data['hw0_i'][0] // data['hw0_c'][0]
    K0 = get_scaled_K(data['K0'].clone(), scale)
    K1 = get_scaled_K(data['K1'].clone(), scale)
    ...
    if is_training:
        ...
        R_gt = data['T_0to1'][:, 0:3, 0:3]  # [N, 3, 3]
        t_gt = data['T_0to1'][:, 0:3, [3]]    # [N, 3, 1]
