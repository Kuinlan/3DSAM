...
_CN.COARSE.NHEAD = 8
_CN.COARSE.LAYER_NAMES = ['self', 'cross'] * 2
...
# 3.3. cross-attention module config
_CN.CROSS_ATTENTION = CN()
_CN.CROSS_ATTENTION.MP = False
_CN.CROSS_ATTENTION.HALF = False
_CN.CROSS_ATTENTION.AREA_WIDTH = None
_CN.CROSS_ATTENTION.D_MODEL = 256
_CN.CROSS_ATTENTION.NHEAD = 8
_CN.CROSS_ATTENTION.LAYER_NAMES = ['cross'] * 1
_CN.CROSS_ATTENTION.AGG_SIZE0 = 4
_CN.CROSS_ATTENTION.AGG_SIZE1 = 4
_CN.CROSS_ATTENTION.NO_FLASH = False
_CN.CROSS_ATTENTION.ROPE = False,  
_CN.CROSS_ATTENTION.NPE = [480, 640, 480, 640]

# 3.4 geometric-attention module config
_CN.GEOMETRIC_ATTENTION = CN()
_CN.GEOMETRIC_ATTENTION.AREA_WIDTH = 10
