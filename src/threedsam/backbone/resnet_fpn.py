...
class ResNetFPN_32(nn.Module):
    """
    ResNet+FPN, output resolution are 1/32, 1/16, 1/8 and 1/2.
    ...
    def __init__(self, config):
        ...
        # Config
        block = BasicBlock
        initial_dim = config['initial_dim']  # 64
        block_dims = config['block_dims']  # [64, 128, 256, 512, 768]
    ...
    def forward(self, x):
        ...
        return [x5_out, x4_out, x3_out, x1_out]  # [1/32, 1/16, 1/8, 1/2]
